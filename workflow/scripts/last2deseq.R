...
..last2Deseq <- function(in_dir, df_sampleInfo, design, gene_isoform_mapping, countsFromAbundance="no"){
...
last2deseq <- function(in_dir, out_dir, sample_info, factors, design, gene_isoform_mapping){
  ...
  if(gene_isoform_mapping != "NULL" && !file.exists(gene_isoform_mapping)) {
